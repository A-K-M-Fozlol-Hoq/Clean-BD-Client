            ...
            <div className="col-md-10 p-4 pr-5" style={{ position: "absolute", right: 0, backgroundColor: "#F4FDFB" }}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input onBlur={handleBlur} type="text" className="form-control" name="userName" placeholder="Enter Your Name" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="exampleInputPassword1">Review</label>
                        <input onBlur={handleBlur} type="text" className="form-control" name="review" placeholder="Write a comment..." />
                    </div>
                    <div className="form-group">
